...
In replicating Ichino and Nathan (2013), I used R. The data and code come from Harvard Dataverse. The code in this paper can be found on GitHub^[https://github.com/angelafu7/CrossingTheLineReplication].
...
w.dist<- data5 %>%
  select(vote_npp_pres, akan_30km_l_p, eth_akan, eth_ewe, eth_dagomba, male, economy_oneyear, poverty, dev_factor2, r4, fid0725) %>%
  na.omit() 
